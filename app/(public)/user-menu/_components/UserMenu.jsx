...
function UserMenu({ menu }) {
  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-base-200 flex flex-col sm:flex-row sm:items-center justify-between p-2 my-12 rounded-lg">
        <span className="font-semibold">Menu Makanan</span>
